...
面向 PM 的桌面端 AI Agent（Apache-2.0）。Tauri v2 + Claude Agent SDK，27 个 PM Skill + 5 Agent + 23 本书方法论 KB。使用 Conventional Commits，不提交敏感信息。
...
27 个 PM Skill + 3 个端到端 Workflow + 23 本 PM 方法论知识库，路由表见 `bundled-agents/pm-copilot/CLAUDE.md`。
