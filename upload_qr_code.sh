...
# Configuration - same bucket as publish_release.sh (download.pm-copilot.io domain)
R2_BUCKET="pm-copilot-releases"
TARGET_PATH="assets/feedback_qr_code.png"
PUBLIC_URL="https://download.pm-copilot.io/${TARGET_PATH}"

echo -e "${CYAN}╔════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║     PM Copilot QR Code Upload Tool               ║${NC}"
echo -e "${CYAN}╚════════════════════════════════════════════════╝${NC}"
echo ""
