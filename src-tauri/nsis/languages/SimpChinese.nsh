; Simplified Chinese language file for PM Copilot NSIS Installer
...
LangString alreadyInstalledLong ${LANG_SIMPCHINESE} "检测到您已安装了 PM Copilot $R5 版本。$\n$\n您可以选择重新安装或卸载。"
...
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "已安装更新的 ${PRODUCTNAME} 版本！不建议安装旧版本。如果确实要安装，建议先卸载当前版本。选择您的操作方式："
LangString older ${LANG_SIMPCHINESE} "旧的"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "检测到您已安装了 PM Copilot $R5 版本，当前正在安装 PM Copilot ${VERSION} 版本。$\n$\n您可以直接下一步进行安装。"
