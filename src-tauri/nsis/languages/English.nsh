; English language file for PM Copilot NSIS Installer
...
LangString alreadyInstalledLong ${LANG_ENGLISH} "PM Copilot $R5 is already installed.$\n$\nYou can choose to reinstall or uninstall."
...
LangString failedToKillApp ${LANG_ENGLISH} "Failed to terminate ${PRODUCTNAME}. Please close it first then try again."
...
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "PM Copilot $R5 is already installed. You are about to install PM Copilot ${VERSION}.$\n$\nYou can proceed with the upgrade directly."
