...
Function PageReinstall
  ...
  ; PM Copilot: Save old version string before comparison overwrites $R0
  StrCpy $R5 $R0
  ...
  ; Upgrading - PM Copilot: swapped options so "overwrite upgrade" is default
  ${ElseIf} $R0 = 1
...
Function PageLeaveReinstall
  ...
  ${If} $R0 = 0 ; Same version, proceed
    ...
    ${Else}                    ; User chose to uninstall
      Goto reinst_uninstall
    ${EndIf}
  ${ElseIf} $R0 = 1 ; Upgrading - PM Copilot: inverted logic due to swapped options
...
; PM Copilot: Git for Windows installation section
  ...
  ${If} $4 == ""
    ...
    git_not_found:
      ...
      ${If} $UpdateMode <> 1
        ...
        ; Path relative from build dir (target/release/nsis/x64/) to source (src-tauri/nsis/)
