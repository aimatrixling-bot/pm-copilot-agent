...
Write-ColorOutput "║  🤖 PM Copilot Windows Dev 构建                         ║" "Cyan"
...
$oldExe = Join-Path $PROJECT_DIR "src-tauri/target/x86_64-pc-windows-msvc/debug/pm-copilot.exe"
if (Test-Path $oldExe) {
