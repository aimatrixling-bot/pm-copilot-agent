 ...
 *
 * Channel Plugins running via Plugin Bridge, displayed as built-in platforms
 * with custom icons, branding, and setup guidance.
 */
...
export interface PromotedPlugin {
    ...
    /** Platform not yet verified in PM Copilot — shows "敬请期待" badge */
    comingSoon?: boolean;
     ...
     *   Both paths write to pluginConfig and then start normally via config auth.
...
export const PROMOTED_PLUGINS: PromotedPlugin[] = [
    {
        ...
        name: '飞书',
        channelBrand: 'feishu',
        description: '飞书开放平台官方插件，支持文档/表格/日历等深度集成',
        icon: feishuIcon,
    ...
    },
    {
        ...
        setupGuide: {
            ...
            credentialHintLink: 'https://q.qq.com/qqbot/',
            steps: [
                {
                    image: qqbotStep1Img,
                    ...
                    captionLinkUrl: 'https://q.qq.com/qqbot/',
                },
                {
                    image: qqbotStep2Img,
    ...
    },
    {
        ...
        channelBrand: 'wecom',
        comingSoon: true,
        description: '腾讯企业微信官方插件，WebSocket 长连接、流式回复',
        icon: wecomIcon,
